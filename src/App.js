  ...
  render() {
    return (
      <React.Fragment>
        ...
        <OfficeOffer width={this.state.width} />
        <PregnantOffer width={this.state.width} />
        <Location width={this.state.width} />

        <Social scroll={this.state.scrollPosition} width={this.state.width} />
        <Footer />
        {this.state.scrollPosition > 200 &&
        this.state.scrollPosition < this.state.offsetTopFooter ? (
          <Nav />
        ) : null}
        <FooterSign />
        <CookieConsent
