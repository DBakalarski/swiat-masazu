                ...
                <section id="oferta-dla-firm" className={office}>
                    <div className={this.state.visible ? `${officeHide} ${officeShow} ` : officeHide}>
                        ...
                        <span className={separator}></span>
                                    ...
                                    <a href="mailto:klaudiaswiatmasaz@gmail.com"> <button className={button}>Uzyskaj indywidulaną ofertę</button></a>

                                    <div className={email}>klaudiaswiatmasaz@gmail.com</div>
                                </div>
