                ...
                <div className={description_container}>
                  ...
                  <div className={description}>
                    ...
                    <div className={main_description}>
                      <p>
                        Masaż kobiet w trakcie ciąży i zaraz po porodzie nie
                        tylko relaksuje oraz przynosi ulgę, ale również działa
                        przeciwobrzękowo. Masaż brzucha i ud zapobiega
                        rozstępom.{" "}
                      </p>
                      <p>
                        Masaż kobiet w ciąży wykonywany jest pomiędzy 3 a 8
                        miesiącem ciąży.{" "}
                      </p>
                      <p>
                        Obejmuje takie partie ciała jak: barki, kark, szyja,
                        kręgosłup (szczególnie odcinek lędźwiowy i krzyżowy),
                        brzuch, kończyny dolne i górne.{" "}
                      </p>
                      <p>
                        Pamiętajcie, że po cesarskim cięciu trzeba mobilizować
                        bliznę.{" "}
                      </p>
                      <p>
                        Codzienna pielęgnacja i masaż sprawią, że blizna nie
                        będzie sztywna oraz nie pojawiają się problemy z bólem
                        kręgosłupa.
                      </p>
                    </div>
                    ...
                    <div className={additional_description}>
                      <p>
                        UWAGA, PRZED MASAŻEM WYMAGAMY ZGODY LEKARZA NA WYKONANIE
                        MASAŻU.{" "}
                      </p>
                      <p>
                        <span>Przeciwwskazania</span>: podwyższone ciśnienie
                        tętnicze, podwyższona temperatura ciała, ciąża
