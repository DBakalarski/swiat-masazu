...
class PregnantOffer extends Component {
    ...
    render() {
        const { pregnant, pregnantShow, description_container, description, header, separator, pregnant_container, main_description, additional_separator, additional_description, pricing_container, pricing_header, pricing_separator, pricing_content } = styles
        return (
            <VisibilitySensor
                ...
                partialVisibility
            >
                <section id="masaz-ciaza" className={this.state.visible ? `${pregnant} ${pregnantShow} ` : pregnant}>
