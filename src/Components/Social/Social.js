          ...
          >
            <div className="container">
              <div className={booksy_container}>
                ...
                <a
                  href="https://booksy.com/pl-pl/15274_klaudia-lejko-swiat-masazu_masaz_15608_poznan"
                  target="_blank"
              ...
              <div className={facebook_container}>
                ...
                <div className={circle_number}>
                  <VisibilitySensor
                    onChange={this.onVisibilityCounterChange}
                    delayedCall
                  >
                    <CountUp
                      delay={2}
                      start={0}
                      end={this.state.visibleCounter ? 1403 : 0}
                      duration={3}
                    />
                  </VisibilitySensor>
                </div>
                <p className={additional_description}>
